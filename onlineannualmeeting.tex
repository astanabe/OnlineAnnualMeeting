...
次に「Settings→bbp Style Pack」を以下のように設定します(記述なしはデフォルトのまま)。
...
\item[Topic/Reply Form: 10. Topic Posting Rules: Topic Rules text] <p>You must add presentation ID to the title.</p><p>必ず講演IDをタイトル冒頭に付加して下さい。</p>
